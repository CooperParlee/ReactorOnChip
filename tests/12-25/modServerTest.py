"""
Filename: modServerTest.py
Author: Cooper Parlee <cooper.parlee@mma.edu>
Date: 12-31-2025
Description: Test the hosting of a randomized sensor with PyModbus
"""
...
async def run_server():
    ...
    store = ModbusDeviceContext(
        ...
        ir = ModbusSequentialDataBlock(400, [456]*100), # input registers (100) - read only 16-bit
    )
